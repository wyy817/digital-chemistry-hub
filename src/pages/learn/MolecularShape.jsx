...
const TOC = [
  { id: 's1', label: '1.3.1 分子为什么有形状' },
  { id: 's2', label: '1.3.2 常见几何构型' },
  { id: 's3', label: '1.3.3 分子极性' },
  { id: 's4', label: '1.3.4 手性与对映体' },
  { id: 's5', label: '1.3.5 手性在药物发现中的重要性' },
      ...
      <div className="learn-two-col anim-fade-in">
        <div className="learn-content-main">
          <nav className="breadcrumb anim-fade-up anim-delay-1">
            <Link to="/">Dashboard</Link><span className="breadcrumb-sep">›</span><span>Chemistry Fundamentals</span><span className="breadcrumb-sep">›</span><span>Ch1. Atoms & Chemical Bonds</span><span className="breadcrumb-sep">›</span><span style={{ color: 'var(--color-text)' }}>{meta.titleZh}</span>
          </nav>
          ...
          <div id="content-main" ref={contentRef} onMouseUp={handleMouseUp} className="anim-fade-up anim-delay-4"><Ch1MolecularShapeContent /></div>
          <div style={{ marginTop: '2.5rem' }}>
            ...
            {showQuiz && <QuickCheck quiz={ch13QuickCheck} onComplete={({ passed }) => { if (passed) setIsCompleted(true) }} />}
          </div>
