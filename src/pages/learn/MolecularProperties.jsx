...
import { Ch3MolecularPropertiesContent, ch3MolecularPropertiesMeta } from '../../content/ch3-molecular-properties'
import { ch31QuickCheck } from '../../content/ch3-molecular-properties-quiz'

const PAGE_ID = 'ch3-1-molecular-properties'

const TOC = [
  { id: 's1', label: '3.1.1 分子描述符' },
  { id: 's2', label: '3.1.2 Lipinski Ro5 与类药性' },
  { id: 's3', label: '3.1.3 ADMET 概述' },
  { id: 's4', label: '3.1.4 吸收与分布' },
  { id: 's5', label: '3.1.5 代谢、排泄与毒性' },
  { id: 's6', label: '3.1.6 QSAR 简介' },
]
...
export default function MolecularProperties() {
  const { user } = useAuth()
  ...
  const meta = ch3MolecularPropertiesMeta
    ...
    <Layout progress={progress} annotations={annotations} onDeleteAnnotation={deleteAnnotation} onUpdateAnnotation={updateAnnotation} showAnnotations wide initialSidebarCollapsed>
      <div className="learn-two-col anim-fade-in">
        <div className="learn-content-main">
          ...
          <div id="content-main" ref={contentRef} onMouseUp={handleMouseUp} className="anim-fade-up anim-delay-4"><Ch3MolecularPropertiesContent /></div>
          <div style={{ marginTop: '2.5rem' }}>
            ...
            {showQuiz && <QuickCheck quiz={ch31QuickCheck} onComplete={({ passed }) => { if (passed) setIsCompleted(true) }} />}
          </div>
