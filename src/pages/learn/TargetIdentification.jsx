...
import { Ch5TargetIdentificationContent, ch5TargetIdentificationMeta } from '../../content/ch5-target-identification'
import { ch52QuickCheck } from '../../content/ch5-target-identification-quiz'

const PAGE_ID = 'ch5-2-target-identification'

const TOC = [
  { id: 's1', label: '5.2.1 什么是靶点？' },
  { id: 's2', label: '5.2.2 传统靶点识别方法' },
  { id: 's3', label: '5.2.3 AI 辅助靶点识别' },
  { id: 's4', label: '5.2.4 靶点验证' },
  { id: 's5', label: '5.2.5 可成药性分析' },
  { id: 's6', label: '5.2.6 AlphaFold 的影响' },
]
...
export default function TargetIdentification() {
  ...
  const meta = ch5TargetIdentificationMeta
    ...
    <Layout progress={progress} annotations={annotations} onDeleteAnnotation={deleteAnnotation} onUpdateAnnotation={updateAnnotation} showAnnotations wide initialSidebarCollapsed>
      <div className="learn-two-col anim-fade-in">
        <div className="learn-content-main">
          ...
          <div id="content-main" ref={contentRef} onMouseUp={handleMouseUp} className="anim-fade-up anim-delay-4"><Ch5TargetIdentificationContent /></div>
          <div style={{ marginTop: '2.5rem' }}>
            ...
            {showQuiz && <QuickCheck quiz={ch52QuickCheck} onComplete={({ passed }) => { if (passed) setIsCompleted(true) }} />}
          </div>
