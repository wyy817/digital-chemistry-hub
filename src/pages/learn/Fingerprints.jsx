...
import { Ch4FingerprintsContent, ch4FingerprintsMeta } from '../../content/ch4-fingerprints'
import { ch42QuickCheck } from '../../content/ch4-fingerprints-quiz'

const PAGE_ID = 'ch4-2-fingerprints'

const TOC = [
  { id: 's1', label: '4.2.1 什么是分子指纹？' },
  { id: 's2', label: '4.2.2 常见指纹类型' },
  { id: 's3', label: '4.2.3 RDKit 批量生成指纹' },
  { id: 's4', label: '4.2.4 Tanimoto 相似性系数' },
  { id: 's5', label: '4.2.5 虚拟筛选与相似性搜索' },
  { id: 's6', label: '4.2.6 指纹的局限性与选择建议' },
]
...
export default function Fingerprints() {
  ...
  const meta = ch4FingerprintsMeta
    ...
    <Layout progress={progress} annotations={annotations} onDeleteAnnotation={deleteAnnotation} onUpdateAnnotation={updateAnnotation} showAnnotations wide initialSidebarCollapsed>
      <div className="learn-two-col anim-fade-in">
        <div className="learn-content-main">
          ...
          <div id="content-main" ref={contentRef} onMouseUp={handleMouseUp} className="anim-fade-up anim-delay-4"><Ch4FingerprintsContent /></div>
          <div style={{ marginTop: '2.5rem' }}>
            ...
            {showQuiz && <QuickCheck quiz={ch42QuickCheck} onComplete={({ passed }) => { if (passed) setIsCompleted(true) }} />}
          </div>
