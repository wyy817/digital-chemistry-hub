...
import { Ch3ReactionMechanismsContent, ch3ReactionMechanismsMeta } from '../../content/ch3-reaction-mechanisms'
import { ch33QuickCheck } from '../../content/ch3-reaction-mechanisms-quiz'

const PAGE_ID = 'ch3-3-reaction-mechanisms'

const TOC = [
  { id: 's1', label: '3.3.1 有机反应的四大类型' },
  { id: 's2', label: '3.3.2 箭推法' },
  { id: 's3', label: '3.3.3 亲核取代反应' },
  { id: 's4', label: '3.3.4 消除反应' },
  { id: 's5', label: '3.3.5 逆合成分析' },
  { id: 's6', label: '3.3.6 AI 辅助合成路线规划' },
]
...
export default function ReactionMechanisms() {
  ...
  const meta = ch3ReactionMechanismsMeta
    ...
    <Layout progress={progress} annotations={annotations} onDeleteAnnotation={deleteAnnotation} onUpdateAnnotation={updateAnnotation} showAnnotations wide initialSidebarCollapsed>
      <div className="learn-two-col anim-fade-in">
        <div className="learn-content-main">
          ...
          <div id="content-main" ref={contentRef} onMouseUp={handleMouseUp} className="anim-fade-up anim-delay-4"><Ch3ReactionMechanismsContent /></div>
          <div style={{ marginTop: '2.5rem' }}>
            ...
            {showQuiz && <QuickCheck quiz={ch33QuickCheck} onComplete={({ passed }) => { if (passed) setIsCompleted(true) }} />}
          </div>
