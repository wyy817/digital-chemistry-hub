...
import { Ch6MolecularDockingContent, ch6MolecularDockingMeta } from '../../content/ch6-molecular-docking'
import { ch63QuickCheck } from '../../content/ch6-molecular-docking-quiz'

const PAGE_ID = 'ch6-3-molecular-docking'

const TOC = [
  { id: 's1', label: '6.3.1 分子对接的核心思想' },
  { id: 's2', label: '6.3.2 AutoDock Vina 与对接流程' },
  { id: 's3', label: '6.3.3 评分函数的三大类型' },
  { id: 's4', label: '6.3.4 虚拟筛选：百万到几十个候选' },
  { id: 's5', label: '6.3.5 AI 增强对接：DiffDock' },
  { id: 's6', label: '6.3.6 案例：Mpro 抑制剂发现' },
]
...
export default function MolecularDocking() {
  ...
  const meta = ch6MolecularDockingMeta
    ...
    <Layout progress={progress} annotations={annotations} onDeleteAnnotation={deleteAnnotation} onUpdateAnnotation={updateAnnotation} showAnnotations wide initialSidebarCollapsed>
      <div className="learn-two-col anim-fade-in">
        <div className="learn-content-main">
          ...
          <div id="content-main" ref={contentRef} onMouseUp={handleMouseUp} className="anim-fade-up anim-delay-4"><Ch6MolecularDockingContent /></div>
          <div style={{ marginTop: '2.5rem' }}>
            ...
            {showQuiz && <QuickCheck quiz={ch63QuickCheck} onComplete={({ passed }) => { if (passed) setIsCompleted(true) }} />}
          </div>
