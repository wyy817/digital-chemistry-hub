...
import { Ch2FunctionalGroupsContent, ch2FunctionalGroupsMeta } from '../../content/ch2-functional-groups'
import { ch21QuickCheck } from '../../content/ch2-functional-groups-quiz'

const PAGE_ID = 'ch2-1-functional-groups'

const TOC = [
  { id: 's1', label: '2.1.1 什么是官能团' },
  { id: 's2', label: '2.1.2 含氧官能团' },
  { id: 's3', label: '2.1.3 含氮官能团' },
  { id: 's4', label: '2.1.4 含硫与卤素官能团' },
  { id: 's5', label: '2.1.5 芳香环与杂环' },
  { id: 's6', label: '2.1.6 官能团与药物性质' },
]
...
export default function FunctionalGroups() {
  ...
  const meta = ch2FunctionalGroupsMeta
    ...
    <Layout progress={progress} annotations={annotations} onDeleteAnnotation={deleteAnnotation} onUpdateAnnotation={updateAnnotation} showAnnotations wide initialSidebarCollapsed>
      <div className="learn-two-col anim-fade-in">
        <div className="learn-content-main">
          ...
          <div id="content-main" ref={contentRef} onMouseUp={handleMouseUp} className="anim-fade-up anim-delay-4"><Ch2FunctionalGroupsContent /></div>
          <div style={{ marginTop: '2.5rem' }}>
            ...
            {showQuiz && <QuickCheck quiz={ch21QuickCheck} onComplete={({ passed }) => { if (passed) setIsCompleted(true) }} />}
          </div>
